...
<body>
    <div class="content">
        ...
        <div class="header">
            <div class="header-wrap">
                ...
                <div class="mobile" style="display: none;">
                    <a href="oferta"><div class="mobile-button mobile-button-first" style="display: none;" onclick="menusetting(1)">Oferta</div></a>
        ...
        <div class="index-content">
            <div class="banner" style="margin-top: 20px"><img src="data/img/baner.jpg" alt="Baner" id="bannerImg"></div>
...
END;
        ...
        <div class="footer">
            <div class="footer-wrap">
                <div class="firm-footer">&copy; Tortownia Sandomierz 2021</div>
                <div class="firm-footer"><iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FTortownia-Sandomierz-105582241612151%2F&tabs&width=340&height=70&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" title="facebook-frame" width="340" height="70" style=";overflow:hidden" name="facebook"  allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share; fullscreen"></iframe></div>
